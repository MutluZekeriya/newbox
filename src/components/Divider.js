...
const Divider = () => {
    return (
        <div id="divider" className="container-fluid py-4 bg-warning d-none d-sm-none d-md-block">
            <div className="container">
                <div className="row g-0">
                    ...
                    <div className="col-md-3 col-sm-4 align-self-center">
                        <Link id="btn-divider" className="btn btn-light" to="/contact"> Fiyat Teklifi Al</Link>
                    </div>
                </div>
            </div>
        </div>
